...
#define LML_ERRORCODE_FAILED_TO_GET_TEMP_DIRECTORY				static_cast<std::uint32_t>(0x00000003)
#define LML_ERRORCODE_FAILED_TO_GET_TEMP_FILE					static_cast<std::uint32_t>(0x00000004)
